...
export default function QuizPage() {
  ...
  const BackgroundShapes = () => (
    <div className="fixed inset-0 pointer-events-none opacity-[0.03] z-0 overflow-hidden flex flex-wrap gap-8 justify-around items-center p-8 mix-blend-screen">
      {[...Array(40)].map((_, i) => {
        ...
        <div className="relative min-h-[80vh] flex flex-col items-center justify-center p-6 z-10">
          ...
          >
            <div className="mb-12 space-y-4">
              <div className="flex justify-center gap-6 mb-4 text-indigo-400 font-black text-5xl">
                <span>○</span>
                <span>△</span>
                <span>□</span>
              </div>
                    ...
                    <div className="space-y-4 mb-6">
                      {question.options.map((option, idx) => {
                        ...
                        return (
                          ...
                          >
                            <span className="w-10 h-10 shrink-0 bg-black/40 text-gray-400 flex items-center justify-center rounded-full font-black text-xl mr-4 border border-white/5 shadow-inner">
                              {shapes[idx % 4]}
                            </span>
...
console.log("Successfully rewrote QuizPage.tsx to match website colors and added rounding");
